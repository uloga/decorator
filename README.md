...
==========
NOTE: NEW LIGHTWEIGHT REWRITTEN FROM SCRATCH ANGULARJS VERSION OF DECORATOR FRAMEWORK WILL BE ADDED TO THIS REPO NEXT WEEK. ALSO A SPECIAL NODE.JS TOOL I WAS WORKING ON FOR SUPER FAST PROTOTYPING AND A DRAG AND DROP VISUALIZATION EDITOR WILL BE INCLUDED. STAR OR FOLLOW PLEASE.
------
